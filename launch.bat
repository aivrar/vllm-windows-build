...
REM ============================================================
set "NEEDS_INSTALL=0"
set "EXPECTED_WHEEL_SHA256=A3E9A18B671673771AD233EA75C3E14F4D598BB1468D31565BEC07E0111F96BC"
...
if not exist "%~dp0python\libs\python314.lib" set "NEEDS_INSTALL=1"
if not exist "%~dp0python\python314._pth" set "NEEDS_INSTALL=1"
